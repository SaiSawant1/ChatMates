...
import { ChannelFormValidator, ChannelFormSchema } from "@/lib/form-schema";
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger className="bg-zinc-300/50 border-0 focus:ring-0 focus:ring-offset-0 text-black capitalize outline-none">
